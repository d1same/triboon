...
# that does not match package/Cargo/Tauri version 2.8.11.
powershell -ExecutionPolicy Bypass -File .\clients\windows-px8\scripts\build-package.ps1 -Tag v2.8.11
```
